...
abstract class Sql {
	...
	protected static function getSql($action = 'select'){
		if(static::$select){
			...
			return static::$sql = static::$select . static::$from . static::$join . static::$where . static::$group . static::$order . static::$limit;
		}
		elseif(static::$set){
			static::update_sql()::set()::where();
			return static::$sql = static::$update . static::$set . static::$where;
		}
		elseif(static::$into && static::$values){
			static::insert()::into()::values();
			return static::$sql = static::$insert . static::$into . static::$values;
		}
		elseif(static::$delete){
			static::delete_sql()::where();
			return static::$sql = static::$delete . static::$where;
		}
		return static::$sql;
	}
