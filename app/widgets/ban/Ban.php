...
class Ban {
	...
	public static array $ban_ip = [];
	public static string $user_ip;
	/* Сообщение при банне ip */
	public static string $ban_message = "Для вашего IP (%ip%) доступ к сайту закрыт.";
	/* Предупреждение о возможности бана по ip */
	public static string $wrong_message = "Вы предупреждены администратором данного сайта о возможной блокировке вашего IP (%ip%) в случае дальнейшего нарушения правил.";

	public static function getBan(): array {
		return self::$ban_ip = [
