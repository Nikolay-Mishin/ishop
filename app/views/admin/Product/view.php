                            ...
                            <div class="col-md-4">
                                <div class="box box-danger box-solid file-upload">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="single">
                                            <img src="/images/<?=$product->img;?>" alt="" style="max-height: 150px; <?=$product->img != 'no_image.jpg' ? 'cursor: pointer;' : ''?>" data-id="<?=$product->id;?>" data-src="<?=$product->img;?>" data-upload="single" <?=$product->img != 'no_image.jpg' ? 'class="del-item"' : ''?>>
                                        </div>
                                    </div>
                                    <div class="overlay">
